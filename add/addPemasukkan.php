    ...
    <div class="login">
        <div class="login-wrapper">
            <div class="container">
                ...
                <div class="content">
                    <form action="addPemasukkan.php" method="post" name="income" >
                    <table class="main-content">
                        <tr>
                            <td class="label"><label for="">Income Balance</label></td>
                            <td><input class="text" type="text" name="saldo" placeholder="Income" id="username" autocomplete="off"></td>
                        </tr>
                        <tr>
